    ...
    <body>
        ...
        <section id="title" class="emerald">
            <div class="container">
                <div class="row">
                    <div class="col-sm-6">
                        <h1>Você já está cadastrado como Guia</h1>
                    </div>
                </div>
            </div>
        </section><!--/#title--> 
        <%      UsuarioDao dao = new UsuarioDao();
                ...
                guia = daoguia.getGuiaById(user.getCodigoCliente());
            ...
            <fieldset>
                ...
                <table cellspacing="10" class="text-center">
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <input type="text" name="Fregistro" maxlength="35" size="35" required value="<%= guia.getNumerodoregistro()%>" >
                        </td>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <select name="Fcategoria1"> 
                                <option value=""><%= guia.getCategoria1()%></option> 
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <select name="Fcategoria2"> 
                                <option value=""><%= guia.getCategoria2()%></option>  
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <input type="date" name="Fdtexpedicao" required value="<%= guia.getDataexpedicao()%>">
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <select name="Fidioma1">
                               <option value=""><%= guia.getIdioma1()%></option>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <select name="Fidioma2">
                                <option value=""><%= guia.getIdioma2()%></option>
                                <option value="Arabe">Árabe</option> 
                                <option value="Espanhol">Espanhol</option> 
                                <option value="Frances">Francês</option> 
                                <option value="Ingles">Inglês</option> 
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <select name="Fidioma3"> 
                                <option value=""><%= guia.getIdioma3()%></option>
                                <option value="Arabe">Árabe</option> 
                                <option value="Espanhol">Espanhol</option> 
                                <option value="Frances">Francês</option> 
                                <option value="Ingles">Inglês</option> 
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <input type="date" name="Fdatecnh" required value="<%= guia.getDtcnhvencimento()%>">
                        </td>
                    </tr>
                </table>
            </fieldset>

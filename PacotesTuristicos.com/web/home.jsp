...
<section id="testimonial" class="alizarin">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="center">
                    <h2>Mais de 10 milhões de viajantes escolhem e indicam PacTur.</h2>
                </div>
                <div class="gap"></div>
                <div class="row">
                    <div class="col-md-6">
                        <blockquote>
                            <p>"Excelente! praticidade e rapidez."</p>
                            <small>JOSE LEAO DA SILVA</small>
                        </blockquote>
                        <blockquote>
                            <p>"Acesso fácil e eficiente as informações."</p>
                            <small>MARIA T D VILLORA</small>
                        </blockquote>
                    </div>
                    <div class="col-md-6">
                        <blockquote>
                            <p>"Muito bom o atendimento"</p>
                            <small>ANTONIO DE SA BARROS</small>
                        </blockquote>
                        <blockquote>
                            <p>"Valores sem surpresas no final, fácil e prático."</p>
                            <small>MARIA LINO ROGERIO MOURA</small>
                        </blockquote>
                    </div>
                </div>
            </div>
